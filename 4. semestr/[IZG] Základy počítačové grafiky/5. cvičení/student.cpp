                     ...
                     const S_Material &material)
{
  ...
  S_Coords pozice_kamery;
  
  pozice_kamery.x = 0 - tc.x;
  pozice_kamery.y = 0 - tc.y; 
  pozice_kamery.z = -CAMERA_DIST - tc.z;

  double uhel_kamery = (pozice_kamery.x * no.x) + (pozice_kamery.y * no.y) + (pozice_kamery.z * no.z);
